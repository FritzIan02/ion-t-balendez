...
const Home: React.FC = () => {
  ...
  const cards = [
    { id: 1, title: 'Click Counter', imageUrl: '', onClick: goToClickCounter },
    { id: 2, title: 'Calculator', imageUrl: '', onClick: goToCalculator },
    { id: 3, title: 'Todo List', imageUrl: '', onClick: goToTodolist },
    { id: 4, title: 'Qoutes Generator', imageUrl: '', onClick: goToQoutesGenerator },
    { id: 5, title: 'Notes', imageUrl: '', onClick: goToNotes },
  ];
