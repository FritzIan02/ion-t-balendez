...
const Profile: React.FC = () => {
  ...
  const handleProceed = () => {
    setShowAlert(false);
    window.open('https://www.facebook.com/fritzian.balendez', '_blank');
  };
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonCard>
          <img alt="Silhouette of mountains" id="cover_pic" onClick={toggleModal_coverpic} src="src/Assets/Img/Cover.jpg" />
          <img alt="Silhouette of mountains" id="profile_pic" onClick={toggleModal_profpic} src="src/Assets/Img/profile.jpg" />  

          <IonCardHeader>
            <IonCardTitle>Fritz Ian Balendez</IonCardTitle>
            <IonCardSubtitle>BSIT Student, 3rd Year - NBSC</IonCardSubtitle>
          </IonCardHeader>

          <IonCardContent><i>Wassup</i>  &#x1F446;</IonCardContent>
          ...
          >
            <img alt="Silhouette of mountains" id="coverpic" src="src/Assets/Img/Cover.jpg" />
