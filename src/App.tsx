    ...
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route exact path="/ion-t-balendez/clickcounter">
            <ClickCounter />
          </Route>
          <Route exact path="/ion-t-balendez/calculator">
            <Calculator />
          </Route>
          <Route exact path="/ion-t-balendez/todolist">
            <Todolist />
          </Route>
          <Route exact path="/ion-t-balendez/quotesgenerator">
            <QuotesGenerator />
          </Route>
          <Route exact path="/ion-t-balendez/notes">
            <Notes />
          </Route>
